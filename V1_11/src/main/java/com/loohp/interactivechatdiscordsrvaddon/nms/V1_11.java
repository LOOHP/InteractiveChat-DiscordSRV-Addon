/*
 * This file is part of InteractiveChatDiscordSrvAddon-V1_11.
 *
...
public class V1_11 extends NMSAddonWrapper {
    ...
    public Map<String, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier> nmsMap = (Map<AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier> entry : nmsMap.entrySet()) {
