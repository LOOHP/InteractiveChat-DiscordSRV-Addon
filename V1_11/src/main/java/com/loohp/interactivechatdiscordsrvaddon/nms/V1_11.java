...
public class V1_11 extends NMSAddonWrapper {
    ...
    public V1_11() {
        try {
            ...
            craftMetaSkullProfileField = Class.forName("org.bukkit.craftbukkit.v1_11_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public List<PotionEffect> getAllPotionEffects(ItemStack potion) {
        net.minecraft.server.v1_11_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(potion);
    ...
    public Map<AttributeBase, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<net.minecraft.server.v1_11_R1.AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier> nmsMap = (Map<net.minecraft.server.v1_11_R1.AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<net.minecraft.server.v1_11_R1.AttributeBase, net.minecraft.server.v1_11_R1.AttributeModifier> entry : nmsMap.entrySet()) {
                net.minecraft.server.v1_11_R1.AttributeBase nmsAttributeBase = entry.getKey();
                AttributeBase attributeBase = new AttributeBase(nmsAttributeBase.getName(), nmsAttributeBase.c());
                net.minecraft.server.v1_11_R1.AttributeModifier nms = entry.getValue();
    ...
    public AdvancementData getAdvancementDataFromBukkitAdvancement(Object bukkitAdvancement) {
        net.minecraft.server.v1_11_R1.Achievement achievement = CraftStatistic.getNMSAchievement((Achievement) bukkitAdvancement);
    ...
    public boolean matchArmorSlot(ItemStack armorItem, EquipmentSlot slot) {
        net.minecraft.server.v1_11_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(armorItem);
    ...
    public Map<EquipmentSlotGroup, Multimap<AttributeBase, AttributeModifier>> getItemAttributeModifiers(ItemStack itemStack) {
        ...
        for (EnumItemSlot slot : EnumItemSlot.values()) {
            ...
            Multimap<String, net.minecraft.server.v1_11_R1.AttributeModifier> nmsMap = nmsItemStack.a(slot);
            for (Map.Entry<String, net.minecraft.server.v1_11_R1.AttributeModifier> entry : nmsMap.entries()) {
