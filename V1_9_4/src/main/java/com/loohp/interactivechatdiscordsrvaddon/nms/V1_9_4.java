/*
 * This file is part of InteractiveChatDiscordSrvAddon-V1_9_4.
 *
...
import net.minecraft.server.v1_9_R2.AttributeBase;
...
public class V1_9_4 extends NMSAddonWrapper {
    ...
    public Map<String, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<AttributeBase, net.minecraft.server.v1_9_R2.AttributeModifier> nmsMap = (Map<AttributeBase, net.minecraft.server.v1_9_R2.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<AttributeBase, net.minecraft.server.v1_9_R2.AttributeModifier> entry : nmsMap.entrySet()) {
