...
public enum PatternTypeWrapper {
	...
	private static final Map<PatternType, PatternTypeWrapper> MAPPING = new HashMap<>();
    ...
    private PatternTypeWrapper(String assetName, String s1, boolean flag) {
        this.assetName = assetName;
    }
    
	private PatternTypeWrapper(String assetName, String s1) {
