...
public class BundleUtils {
    ...
    private static int getWeight(ItemStack itemStack) {
        ...
        if (material.equals(Material.BUNDLE)) {
            ...
            if ((material.equals(Material.BEEHIVE) || material.equals(Material.BEE_NEST)) && NBTEditor.contains(itemStack, "BlockEntityTag")) {
                if (NBTEditor.getSize(itemStack, "BlockEntityTag", "Bees") > 0) {
                    return 64;
                }
            }
