...
public class V1_9 extends NMSAddonWrapper {
    ...
    public Map<AttributeBase, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<net.minecraft.server.v1_9_R1.AttributeBase, net.minecraft.server.v1_9_R1.AttributeModifier> nmsMap = (Map<net.minecraft.server.v1_9_R1.AttributeBase, net.minecraft.server.v1_9_R1.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<net.minecraft.server.v1_9_R1.AttributeBase, net.minecraft.server.v1_9_R1.AttributeModifier> entry : nmsMap.entrySet()) {
                net.minecraft.server.v1_9_R1.AttributeBase nmsAttributeBase = entry.getKey();
