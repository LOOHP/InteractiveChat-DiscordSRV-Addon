...
public class V1_13_1 extends NMSAddonWrapper {
    ...
    public V1_13_1() {
        try {
            ...
            mobEffectListIsDebuffField = MobEffectList.class.getDeclaredField("b");
            ...
            craftMetaSkullProfileField = Class.forName("org.bukkit.craftbukkit.v1_13_R2.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public Map<ICMaterial, TintColorProvider.SpawnEggTintData> getSpawnEggColorMap() {
        try {
            ...
            for (Iterator<Item> itr = IRegistry.ITEM.f().iterator(); itr.hasNext();) {
                Item item = itr.next();
    ...
    public OptionalInt getTropicalFishBucketVariantTag(ItemStack bucket) {
        net.minecraft.server.v1_13_R2.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(bucket);
    ...
    public List<PotionEffect> getAllPotionEffects(ItemStack potion) {
        net.minecraft.server.v1_13_R2.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(potion);
    ...
    public Map<AttributeBase, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<net.minecraft.server.v1_13_R2.AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier> nmsMap = (Map<net.minecraft.server.v1_13_R2.AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<net.minecraft.server.v1_13_R2.AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier> entry : nmsMap.entrySet()) {
                net.minecraft.server.v1_13_R2.AttributeBase nmsAttributeBase = entry.getKey();
                AttributeBase attributeBase = new AttributeBase(nmsAttributeBase.getName(), nmsAttributeBase.c());
                net.minecraft.server.v1_13_R2.AttributeModifier nmsAttributeModifier = entry.getValue();
    ...
    public AdvancementData getAdvancementDataFromBukkitAdvancement(Object bukkitAdvancement) {
        try {
            ...
            net.minecraft.server.v1_13_R2.Advancement advancement = ((CraftAdvancement) bukkitAdvancement).getHandle();
            ...
            ItemStack item = CraftItemStack.asBukkitCopy((net.minecraft.server.v1_13_R2.ItemStack) advancementDisplayItemStackField.get(display));
    ...
    public boolean matchArmorSlot(ItemStack armorItem, EquipmentSlot slot) {
        net.minecraft.server.v1_13_R2.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(armorItem);
    ...
    public Map<EquipmentSlotGroup, Multimap<AttributeBase, AttributeModifier>> getItemAttributeModifiers(ItemStack itemStack) {
        ...
        for (EnumItemSlot slot : EnumItemSlot.values()) {
            ...
            Multimap<String, net.minecraft.server.v1_13_R2.AttributeModifier> nmsMap = nmsItemStack.a(slot);
            for (Map.Entry<String, net.minecraft.server.v1_13_R2.AttributeModifier> entry : nmsMap.entries()) {
    ...
    public String getEntityTypeTranslationKey(EntityType type) {
        EntityTypes<?> entityTypes = EntityTypes.a(type.getName());
        if (entityTypes == null) {
            return "";
        }
