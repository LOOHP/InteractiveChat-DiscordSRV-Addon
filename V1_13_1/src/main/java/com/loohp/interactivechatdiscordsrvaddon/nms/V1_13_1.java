/*
 * This file is part of InteractiveChatDiscordSrvAddon-V1_13_1.
 *
...
public class V1_13_1 extends NMSAddonWrapper {
    ...
    public Map<String, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier> nmsMap = (Map<AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<AttributeBase, net.minecraft.server.v1_13_R2.AttributeModifier> entry : nmsMap.entrySet()) {
