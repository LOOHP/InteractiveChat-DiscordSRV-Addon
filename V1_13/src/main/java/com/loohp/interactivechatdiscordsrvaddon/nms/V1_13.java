...
import net.minecraft.server.v1_13_R1.EnumBannerPatternType;
...
import net.minecraft.server.v1_13_R1.ItemRecord;
...
public class V1_13 extends NMSAddonWrapper {
    ...
    public V1_13() {
        try {
            ...
            craftMetaSkullProfileField = Class.forName("org.bukkit.craftbukkit.v1_13_R1.inventory.CraftMetaSkull").getDeclaredField("profile");
    ...
    public OptionalInt getTropicalFishBucketVariantTag(ItemStack bucket) {
        net.minecraft.server.v1_13_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(bucket);
    ...
    public List<PotionEffect> getAllPotionEffects(ItemStack potion) {
        net.minecraft.server.v1_13_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(potion);
    ...
    public Map<AttributeBase, AttributeModifier> getPotionAttributeModifiers(PotionEffect effect) {
        try {
            ...
            Map<net.minecraft.server.v1_13_R1.AttributeBase, net.minecraft.server.v1_13_R1.AttributeModifier> nmsMap = (Map<net.minecraft.server.v1_13_R1.AttributeBase, net.minecraft.server.v1_13_R1.AttributeModifier>) mobEffectListAttributeModifiersField.get(mobEffectList);
            for (Map.Entry<net.minecraft.server.v1_13_R1.AttributeBase, net.minecraft.server.v1_13_R1.AttributeModifier> entry : nmsMap.entrySet()) {
                net.minecraft.server.v1_13_R1.AttributeBase nmsAttributeBase = entry.getKey();
                AttributeBase attributeBase = new AttributeBase(nmsAttributeBase.getName(), nmsAttributeBase.c());
                net.minecraft.server.v1_13_R1.AttributeModifier nms = entry.getValue();
    ...
    public AdvancementData getAdvancementDataFromBukkitAdvancement(Object bukkitAdvancement) {
        try {
            ...
            net.minecraft.server.v1_13_R1.Advancement advancement = ((CraftAdvancement) bukkitAdvancement).getHandle();
            ...
            ItemStack item = CraftItemStack.asBukkitCopy((net.minecraft.server.v1_13_R1.ItemStack) advancementDisplayItemStackField.get(display));
    ...
    public boolean matchArmorSlot(ItemStack armorItem, EquipmentSlot slot) {
        net.minecraft.server.v1_13_R1.ItemStack nmsItemStack = CraftItemStack.asNMSCopy(armorItem);
    ...
    public Map<EquipmentSlotGroup, Multimap<AttributeBase, AttributeModifier>> getItemAttributeModifiers(ItemStack itemStack) {
        ...
        for (EnumItemSlot slot : EnumItemSlot.values()) {
            ...
            Multimap<String, net.minecraft.server.v1_13_R1.AttributeModifier> nmsMap = nmsItemStack.a(slot);
            for (Map.Entry<String, net.minecraft.server.v1_13_R1.AttributeModifier> entry : nmsMap.entries()) {
